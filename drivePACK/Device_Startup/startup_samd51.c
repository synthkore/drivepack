...
void NMI_Handler             ( void ) __attribute__ ((weak, alias("TestHandlerNMI")));
void HardFault_Handler       ( void ) __attribute__ ((weak, alias("TestHandlerHardFault")));
void MemManage_Handler       ( void ) __attribute__ ((weak, alias("TestHandlerMemManager")));
void BusFault_Handler        ( void ) __attribute__ ((weak, alias("TestHandlerBusFault")));
void UsageFault_Handler      ( void ) __attribute__ ((weak, alias("TestHandlerUsageFault")));
void SVC_Handler             ( void ) __attribute__ ((weak, alias("TestHandlerSVC")));
void DebugMon_Handler        ( void ) __attribute__ ((weak, alias("TestHandlerDebugMon")));
void PendSV_Handler          ( void ) __attribute__ ((weak, alias("TestHandlerPendSV")));
void SysTick_Handler         ( void ) __attribute__ ((weak, alias("TestHandlerSysTick")));
...
void TestHandlerNMI(void)
{
	//while (1) {
	//}
}

void TestHandlerHardFault(void)
{

	//while (1) {
	//}
}
void TestHandlerMemManager(void)
{
	//while (1) {
	//}
}
void TestHandlerBusFault(void)
{
	//while (1) {
	//}
}
void TestHandlerUsageFault(void)
{
	//while (1) {
	//}
}
void TestHandlerSVC(void)
{
	//while (1) {
	//}
}
void TestHandlerDebugMon(void)
{
	//while (1) {
	//}
}
void TestHandlerPendSV(void)
{
	//while (1) {
	//}
}
void TestHandlerSysTick(void)
{
	//while (1) {
	//}
}
